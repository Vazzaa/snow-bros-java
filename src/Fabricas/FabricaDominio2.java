...
public class FabricaDominio2 extends FabricaSkin {

    protected String rutaCarpetaImagenes;

    public FabricaDominio2() {
        super();
        this.rutaCarpetaImagenes = "Imagenes/SkinsAlternativas/";
    }
    ...
    public Skin crearSkinFantasma() {
        ...
        mapeoparafantasma.put(1,"Imagenes/SkinsAlternativas/Fantasma1.gif");
    ...
    public Skin crearSkinPlatTecho(){
        return new Skin(getMapeoEstadoImagen("PlataformaTecho", 2), 1);
    }

    public Skin crearSkinPlatQuebradiza(){
        return new Skin(getMapeoEstadoImagen("PlataformaQuebradiza", 1), 1);
    }
